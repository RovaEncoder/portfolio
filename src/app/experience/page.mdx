...
<p className="pl-6 border border-gray-300 my-2 rounded-sm">
...
<Link
  ...
  className="hover:cursor-pointer w-full flex pl-6 mb-2"
>
  <Image
    src={tagira}
    alt="tagira"
...
<p className="text-gray-400 pl-6 text-sm ">Tagira's Homepage</p>
...
<p className="text-gray-400 pl-6 text-sm">The Praxi.ai Homepage</p>
...
<p className="text-gray-400 pl-6 text-sm">The blog Homepage</p>
